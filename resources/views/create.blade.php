...
@section('content')
    ...
    <div class="w3-row">
        ...
        <div class="w3-col l8">
            <form action="{{ url('/order') }}" class="w3-row w3-animate-zoom" method="post"
                ...
                <div class="formsteps animated slideInRight " id="step1">
                    ...
                    <div class="w3-row">
                        <button onclick="nextStep()" class="w3-btn w3-margin-bottom w3-blue w3-round w3-right"
                                type="button"> Next <i class="fa fa-arrow-right"></i></button>
                    </div>
                </div>
                <div class="formsteps animated slideInRight " id="step2">
                    ...
                    <div class="w3-row w3-margin-top">
                        <button onclick="prevStep()" class="w3-btn w3-margin-bottom w3-blue w3-round w3-left"
                                type="button"><i class="fa fa-arrow-left"></i> Prev
                        </button>
                        <button onclick="nextStep()" class="w3-btn w3-margin-bottom w3-blue w3-round w3-right"
                                type="button"> Next <i class="fa fa-arrow-right"></i></button>
                    </div>
                ...
                <div class="formsteps animated slideInRight " id="step5">
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-col l6 m6" style="padding-left: 4px">
                            ...
                            <small class="w3-text-blue w3-left">Image of the style (if available) Note: Image should not
                                be morethan 500kb</small>
                        </div>
                    </div>
                    <div class="w3-row w3-margin-top">
                        <button onclick="prevStep()" class="w3-btn w3-margin-bottom w3-blue w3-round w3-left"
                        ...
                        <button type="submit" class="w3-btn w3-margin-bottom w3-blue w3-round w3-right" type="button">
