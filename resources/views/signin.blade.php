...
<div class="w3-container" style="margin-top:20px;margin-bottom: 20px;">
	<div class="w3-row w3-animate-zoom">
		...
		<div class="w3-half">
			...
			<div class="w3-center"><i class="fa w3-circle w3-border w3-xxxlarge fa-lock" style="padding:20px;"></i></div>
			<div class="w3-row w3-padding">
				<div class="w3-round w3-padding">
					<form action="{{ url('/signin') }}" class="w3-row w3-animate-zoom" method="post">
						...
						<div class="w3-row">
							<button class="w3-btn w3-mobile w3-margin-bottom w3-theme-d5 w3-round w3-right" type="submit"><i class="fa fa-unlock-alt"></i> Sign In</button>
							<a href="{{ url('/resetpassword') }}" class="w3-mobile w3-margin-bottom bread w3-round w3-text-theme w3-left w3-large" style="text-decoration: none;"><b>Forgot Password? Reset</b></a>
						</div>
						{{ csrf_field() }}
					</form>
				</div>
