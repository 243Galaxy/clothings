...
@if(session('message'))
    ...
    <div class="w3-container">
        <span onclick="this.parentElement.style.display='none'" class="w3-border w3-border-theme w3-hover-red w3-btn"
              style="cursor:pointer;"><span>&times; </span> Close All</span>
