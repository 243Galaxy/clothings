        ...
        <div class="w3-col l8">
            <form action="{{ url('/register') }}" class="w3-row w3-animate-zoom" method="post">
                ...
                <div class="formsteps animated slideInRight " id="step4">
                    ...
                    <div class="w3-row">
                        <div class="w3-col l6 m6" style="padding-right: 4px">
                            <input placeholder="Secret password" class="w3-input w3-round" type="password"
                                   name="password">
                        </div>
                        <div class="w3-col l6 m6" style="padding-left: 4px">
                            <input placeholder="Confirm secret password" class="w3-input w3-round" type="password"
                                   name="cpassword">
                        </div>
                    </div>
                    <div class="w3-row w3-margin-top">
                        <button type="submit" class="w3-btn w3-margin-bottom w3-blue w3-round w3-right" type="button">
                            Register <i class="fa fa-check"></i></button>
                    </div>
                </div>
                {{ csrf_field() }}
            </form>
