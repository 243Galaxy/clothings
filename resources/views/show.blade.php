...
<div class="w3-row">
    <div class="w3-col l5">
        <div class="w3-container w3-center w3-section">
            <img src="{{asset('uploads/avatars/'.$gallery->image2)}}" id="myImg" width="400px" height="450" alt="Image"></b>
        </div>
        </div>
        <div class="w3-col l3">
        <h5> <b class="w3-text-blue">Material:</b> <b>{{$gallery->material}}</b>
            ...
            <div onclick="document.getElementById('id01').style.display='block'" class="w3-btn w3-hover-green w3-button w3-border w3-round w3-blue"><i class="fa fa-pen"></i>Make An Order</div>
        </div>
</div>
<div id="id01" class="w3-modal">
    <div class="w3-modal-content w3-round">
      <div class="w3-container">
        ...
        <form action="{{ url('/orderg') }}" method="post" enctype="multipart/form-data">
            @csrf
