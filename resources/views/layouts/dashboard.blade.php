...
<div id="mySidenav" class="w3-dashboard w3-sidebar w3-collapse" style="width:250px">
    ...
    <div class="w3-center">
        <img class="w3-image w3-round w3-card-4 w3-margin-left" style="height:100px;"
    ...
    <div class="w3-row w3-light-blue">
        ...
        <div class="w3-col l10 m9 s9" style="padding-left: 10px;">
            <div class="w3-dropdown-hover w3-right w3-hover-blue w3-light-blue">
                ...
                <div class="w3-dropdown-content w3-bar-block w3-card-4 w3-animate-zoom" id="m_access"
                     style="width:200px;right:0">
                    <a class="w3-bar-item w3-button w3-hover-blue" href="{{ url('admin/dashboard') }}">Dashboard<i
                            class="w3-right fa fa-bars"></i></a>
                    <a class="w3-bar-item w3-button w3-hover-blue" href="{{ url('admin/updateprofile') }}"><i
                            class="w3-right fa fa-user"></i> Update Profile</a>
                    <a class="w3-bar-item w3-button w3-hover-blue" href="{{ url('admin/logout') }}">Logout<i
                            class="w3-right fa fa-sign-out-alt"></i></a>
                </div>
            </div>
        </div>
    </div>
